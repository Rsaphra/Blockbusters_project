...
def create_tables():
    ...
    # creating the queries for the actual tables
    # setting business id as a primary key and a foreign key
    cnx, cursor = connect_to_db()
...
# helper method, executes a sql query and returns
# the fetchall results
...
def insert_genres(genre_data):
    cnx, cursor = connect_to_db()
    # go through list of genres and insert genre_id
    # and name into DB
